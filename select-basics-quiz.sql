...
-- Q2: Pick the result that would be obtained from this code
...
-- Q6: Select the code that would show countries with area larger
-- than 50000 and population smaller than 10000000
